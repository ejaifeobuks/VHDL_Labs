...
set_property -dict { PACKAGE_PIN T8   IOSTANDARD LVCMOS18 } [get_ports { data_in[8] }];  # SW8
set_property -dict { PACKAGE_PIN U8   IOSTANDARD LVCMOS18 } [get_ports { data_in[9] }];  # SW9
set_property -dict { PACKAGE_PIN R16  IOSTANDARD LVCMOS33 } [get_ports { data_in[10] }]; # SW10
set_property -dict { PACKAGE_PIN T13  IOSTANDARD LVCMOS33 } [get_ports { data_in[11] }]; # SW11
set_property -dict { PACKAGE_PIN H6   IOSTANDARD LVCMOS33 } [get_ports { shift_amt[0] }]; # SW12 = LSB
set_property -dict { PACKAGE_PIN U12  IOSTANDARD LVCMOS33 } [get_ports { shift_amt[1] }]; # SW13 = MSB


## LEDs
set_property -dict { PACKAGE_PIN H17  IOSTANDARD LVCMOS33 } [get_ports { data_out[0] }];   # LED0
set_property -dict { PACKAGE_PIN K15  IOSTANDARD LVCMOS33 } [get_ports { data_out[1] }];   # LED1
set_property -dict { PACKAGE_PIN J13  IOSTANDARD LVCMOS33 } [get_ports { data_out[2] }];   # LED2
set_property -dict { PACKAGE_PIN N14  IOSTANDARD LVCMOS33 } [get_ports { data_out[3] }];   # LED3
set_property -dict { PACKAGE_PIN R18  IOSTANDARD LVCMOS33 } [get_ports { data_out[4] }];   # LED4
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { data_out[5] }];   # LED5
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { data_out[6] }];   # LED6
set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { data_out[7] }];   # LED7
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { data_out[8] }];   # LED8
set_property -dict { PACKAGE_PIN T15  IOSTANDARD LVCMOS33 } [get_ports { data_out[9] }];   # LED9
set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 } [get_ports { data_out[10] }];  # LED10
set_property -dict { PACKAGE_PIN T16  IOSTANDARD LVCMOS33 } [get_ports { data_out[11] }];  # LED11
...
##7 segment display
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { D[7] }]; #IO_L24N_T3_A00_D16_14 Sch=ca
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { D[6] }]; #IO_25_14 Sch=cb
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { D[5] }]; #IO_25_15 Sch=cc
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { D[4] }]; #IO_L17P_T2_A26_15 Sch=cd
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { D[3] }]; #IO_L13P_T2_MRCC_14 Sch=ce
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { D[2]}]; #IO_L19P_T3_A10_D26_14 Sch=cf
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { D[1]}]; #IO_L4P_T0_D04_14 Sch=cg
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { D[0] }]; #IO_L19N_T3_A21_VREF_15 Sch=dp
...
##Buttons
set_property -dict { PACKAGE_PIN N17 IOSTANDARD LVCMOS33 } [get_ports { btn_mode_raw }]; # BTNC
set_property -dict { PACKAGE_PIN M18 IOSTANDARD LVCMOS33 } [get_ports { btn_dir_raw }];  # BTNU
